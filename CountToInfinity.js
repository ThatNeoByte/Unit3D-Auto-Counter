// ==UserScript==
// @name         Unit3D Auto Counter
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Reload page and count posts automatically
...
(function() {
    ...
    function checkThread() {
        ...
        if (canPost && errors.length === 0 && lastKnown !== null) {
            const nextNumber = lastKnown + 1;
            console.info(`[Unit3D] Posting next number: ${nextNumber}`);
            sendPost(nextNumber);
        } else {
            console.info("[Unit3D] Not posting due to errors or ignored user.");
        }
    }
